...
function drawBlock(block) {
    ...
    if (block.text.includes('/')) {
        ...
        let startX = block.x + 20;  // Start positie links
        
        // Split op spaties om delen te krijgen
        ...
        for (let i = 0; i < parts.length; i++) {
            ...
            if (part.includes('/')) {
                ...
                textSize(13);
                text(num, startX + 15, centerY - 10);  // Teller
                
                stroke(255);
                strokeWeight(2);
                line(startX +5 , centerY, startX + 25, centerY);  // Breukstreep
                noStroke();
                
                text(den, startX + 15, centerY + 10);  // Noemer
                ...
                // EQUALS TEKEN
                textSize(16);
                text('=', startX, centerY);  // ← PAS HIER centerY AAN!
                startX += 20;
        ...
        // Gewone tekst zonder breuken (antwoorden zoals "75%")
        textSize(16);
